...
```bash
polygolem analytics positions --user 0x...
polygolem analytics closed-positions --user 0x...
polygolem analytics trades --user 0x... --limit 20
polygolem analytics activity --user 0x... --limit 20
polygolem analytics holders --token-id <token-id> --limit 20
polygolem analytics value --user 0x...
polygolem analytics markets-traded --user 0x...
polygolem analytics open-interest --token-id <token-id>
polygolem analytics leaderboard --limit 20
polygolem analytics live-volume --limit <event-id>
```
...
- [Redeeming Winning Positions](/docs/guides/redeem-winners)
- [Polymarket API Overview](/docs/concepts/polymarket-api)
