...
Polygolem emits `builder-keys = bytes32(0)` by default. Set a non-zero code with
...
- [Go SDK Contracts](/docs/reference/sdk) — public package method signatures
- [Internal Packages](/docs/reference/internal-packages) — full internal API surface
