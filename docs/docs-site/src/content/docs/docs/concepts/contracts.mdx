...
- [Deposit Wallet Lifecycle](/docs/guides/deposit-wallet-lifecycle) — full onboarding walkthrough
- [Secrets Management](/docs/concepts/secrets-management) — builder credential handling
- [Architecture](/docs/concepts/architecture) — package boundaries
- [CLOB API Reference](/docs/reference/clob-api) — order signing and trade endpoints
