...
// a set of asset IDs, exposes deduplicated raw market payloads for recorders,
// plus authenticated user order/trade streams. Start with MarketClient and
// SubscribeAssets for orientation.
//
